...
CREATE FUNCTION funct_load_produto_venda(filter jsonb) RETURNS TABLE(produto_id uuid, produto_nome character varying, produto_codigo character varying, produto_stock numeric, categoria_id uuid, categoria_nome character varying, unidades jsonb)
    LANGUAGE plpgsql
    AS $$
declare
  _const rule.constant;
begin
  ...
  return query
    select
        ...
        cat.categoria_nome,
        lib.agg_jsonb_collect(
          to_jsonb( prec ) || to_jsonb( eq )|| to_jsonb( u )
        )
      from ggviario.produto pro
        inner join ggviario.categoria cat on pro.produto_categoria_id = cat.categoria_id
        inner join equivalencia eq on pro.produto_id = eq.equivalencia_produto_id
        ...
        inner join unidade u on eq.equivalencia_unidade_id = u.unidade_id
          and eq.equivalencia_unidade_id = u.unidade_id
          and prec.preco_unidade_id = u.unidade_id
      group by pro.produto_id,
        cat.categoria_id
    ;
end;
...
2c3033fe-8dd7-4b8c-a287-3a42c091d089	00000000-0000-0000-0000-000000000001	2da10bc7-53c5-4912-b06e-2b407e350eff	00000000-0000-0000-0000-000000000001	\N	1	1	2018-02-21 15:57:11.488731	\N
215de1c3-e6fe-4c2b-8128-96a003ad4951	00000000-0000-0000-0000-000000000001	00000000-0000-0000-0000-000000000001	00000000-0000-0000-0000-000000000001	\N	30	1	2018-02-21 15:57:11.488731	\N
4f874b3d-050d-4eb5-801f-d0cf22b6fc4d	00000000-0000-0000-0000-000000000001	00000000-0000-0000-0000-000000000001	00000000-0000-0000-0000-000000000001	00000000-0000-0000-0000-000000000001	1	0	2018-02-11 13:39:28.175768	2018-02-21 15:57:11.488731
\.
...
e8936437-2088-4d01-82bb-1fd6ed30c6ba	00000000-0000-0000-0000-000000000001	2da10bc7-53c5-4912-b06e-2b407e350eff	00000000-0000-0000-0000-000000000001	\N	150	1	2018-02-21 15:53:47.338879	\N
10b5953d-a8d5-481a-8587-f07f1ed67300	00000000-0000-0000-0000-000000000001	00000000-0000-0000-0000-000000000001	00000000-0000-0000-0000-000000000001	\N	5	1	2018-02-21 15:53:47.338879	\N
\.
...
00000000-0000-0000-0000-000000000001	00000000-0000-0000-0000-000000000001	00000000-0000-0000-0000-000000000001	00000000-0000-0000-0000-000000000001	Ovos	52	0	t	t	t	t	f	1	2018-02-09 18:48:34.984037	2018-02-09 18:48:34.984037	\N
\.
