    ...
    public FontInfo(String pathToFontInfoProperties) {
        ...
        try {
            ...
            if (url.isPresent()) {
                ...
                System.out.printf("An showError accurred while loading '%s'", pathToFontInfoProperties);
            }
        } catch (IOException ex) {
            System.out.printf("An showError accurred while loading '%s': %s", pathToFontInfoProperties, ex.getMessage());
        }
    }
