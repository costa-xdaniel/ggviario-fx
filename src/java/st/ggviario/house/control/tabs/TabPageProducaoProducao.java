...
import st.ggviario.house.control.components.ButtonChooseGroup;
...
public class TabPageProducaoProducao extends TableClontroller< TabPageProducaoProducao.ProducaoModelView > implements TabPage, Initializable {
    ...
    private ButtonChooseGroup buttonChooseGroup;

    @FXML private Label labelProduto;
    @FXML private Label labelSetor;
    @FXML private HBox choseArea;
    ...
    private void structure(){
        ...
        this.buttonChooseGroup = new ButtonChooseGroup( this.choseArea, this.labelProduto, labelSetor);
            ...
            sql.query( "funct_load_producao_vista_produto" )
                    ...
                    .onResultQuery((PostgresSQLResultSet.OnReadAllResultQuery) row -> {
                        Platform.runLater( () -> {
                            ...
                            producaoBuilder.setProduto( prduto );

                            ProducaoModelView producao = new ProducaoModelView( producaoBuilder.build() );
                            this.originalProducaoModelView.add( producao );
    ...
    class ProducaoModelView extends RecursiveTreeObject< ProducaoModelView >{
        ...
        public ProducaoModelView(Producao producao) {
            ...
            this.producaoQuantidadeComercial = new SimpleObjectProperty<>( producao.getProducaoQuantidadeComercial() );
            ...
            this.producaoQuantidadeLancamento = new SimpleObjectProperty<>( producao.getProducaoLancamento() );
        }
    }
}
